...
<html lang="en">
  ...
  <body>
    ...
    <div class="container mt-3">
      <h3 class="text-center"><u>Product</u></h3>
      <div class="row">
        <h5><strong><u>Ready Stock! New Arrival <img src="assets/icon/south-korea.png" alt="" style="width: 25px; height: 25px;"></u></strong></h5>
