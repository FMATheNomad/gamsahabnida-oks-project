...
<body>
	...
	<form class="form-container">
	  ...
	  <div class="mb-3 form-check">
	    ...
	    <label class="form-check-label" for="exampleCheck1">Saya menyetujui <span class="fw-bold"><a href="">Syarat & Ketentuan</a></span> yang berlaku <span class="text-danger">*</span></label>
	  </div>
	  <div>
	  <div class="row">
