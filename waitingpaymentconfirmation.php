...
<body>
	...
	<!-- Navbar End -->
	<!-- Waiting Payment Confirmation Start -->
	<div class="container mt-5">
		<div class="alert alert-success" role="alert">
		  Pembayaran kamu sedang kami cek! Mohon tunggu sebentar, checking payment biasanya hanya memakan waktu beberapa menit saja.
		</div>
	</div>
	<div class="container text-end"><button type="button" class="btn btn-info text-end">← Back to Homepage!</button></div>
	
	<!-- Waiting Payment Confirmation End -->
	<!-- Footer Start -->
	<footer id="footer">
